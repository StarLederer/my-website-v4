              ...
              <div class="flex flex-col items-start gap-m.2">
                <div class="relative">
                  ...
                  <div class="relative flex flex-col gap-s.4 font-semibold">
                    ...
                    <p class="text-fg-2 leading-(s+s.2)" style="max-width: 48ch">I love exploring abstract ideas and discovering new things. I see opportunities in everything and use them to improve the world.</p>
                  </div>
                </div>
                <div class="relative">
